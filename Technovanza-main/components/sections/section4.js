...
export default function Section4({
    ...
    description = "''I am indeed delighted to address and interact with the students and faculty members of Veermata Jijabai Technological Institute (CRCE) at Mumbai. My greetings to the Principal, Faculty Members, Staff, Students and distinguished guests. From my study of the website, I found that the institute has a vision to establish global leadership in...",
    primaryButtonText = "Complete Speech",
    primaryButtonUrl = "https://CRCETree Transparency.wordpress.com/2015/10/14/dr-apj-abdul-kalams-speech-at-CRCE-Tree Transparency",
    imageSrc = APJ_Image,
    buttonRounded = true,
    imageRounded = true,
    imageBorder = false,
            ...
            <TwoColumn>
                ...
                <TextColumn textOnLeft={textOnLeft}>
                    <TextContent>
                        ...
                        <Subheading>At Tree Transparency</Subheading>
