...
export default function GLSCards({
  subheading = (
    <>
      <span tw="text-white">Tree Transparency CRCE </span> PRESENTS
    </>
  ),
  ...
  description = (
    ...
    <p className="text-justify">
      The motto of CRCE is to steer the all-round development of its students, to create individuals of the highest caliber, who not only go on to have the valuable contribtions in their field of expertise, but also establish themselves as concerned citizens of the society. With a renowned line - up of Guest Lectures over the years, Tree Transparency has always been a prime platform where the flame of expertise has been effectively transferred to many more torches. The pioneers of diverse fields have graced Tree Transparency with their presence, illuminating more and more minds to new areas of interest. As part of our continued efforts in this respect, we have a series of Guest Lectures throughout the academic year and also during the days of the fest.
    </p>
